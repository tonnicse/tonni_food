...
const products = [
    { id: 1, name: 'Chicken Biryani',    desc: 'Fragrant basmati rice with tender chicken pieces.',      image: 'images/biryani.jpg',    price: 6.99 },
    { id: 2, name: 'Veg Burger',         desc: 'Grilled veggie patty with fresh lettuce and tomato.',    image: 'images/burger.jpg',     price: 3.49 },
    { id: 3, name: 'Pasta Alfredo',      desc: 'Creamy alfredo sauce over al dente pasta.',             image: 'images/pasta.jpeg',      price: 5.99 },
    { id: 4, name: 'Sushi Platter',      desc: 'Assorted nigiri & rolls with wasabi & pickled ginger.',  image: 'images/sushi.jpg',      price: 12.50 },
    { id: 5, name: 'Loaded Nachos',      desc: 'Corn chips topped with cheese, jalapeños & salsa.',      image: 'images/nachos.jpeg',     price: 6.75 },
    { id: 6, name: 'Choco Heaven Cake',  desc: 'Decadent layered chocolate cake with ganache.',           image: 'images/cake.jpg',       price: 5.25 },
    { id: 7, name: 'Rainbow Macarons',   desc: 'Assorted pastel-colored French macarons.',                image: 'images/macarons.jpg',   price: 4.99 },
    { id: 8, name: 'Tropical Fruit',     desc: 'Seasonal fruits artfully arranged in vibrant display.',   image: 'images/fruits.jpg',     price: 7.50 }
  ];
